function [ f_han ] = ii_plottimeseries_WMLoads( ii_data, ii_cfg, which_chans, varargin )
...
% Adapted for Multi-target all-report experiment setting
% legend(which_chans) reports error, tuned up and see if we could fix it
...
if nargin < 3 || isempty(which_chans)
    which_chans = {'X','Y','TarX1','TarY1','TarX2','TarY2','TarX3','TarY3','TarX4','TarY4'}; %Tarx TarY added on jun17 by TS
end
