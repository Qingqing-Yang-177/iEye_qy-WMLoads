function [ ii_data, ii_cfg ] = ii_calibratebytrial_WMLoads( ii_data, ii_cfg, chan_names, calib_targets, calib_mode, adj_limit )
...
% ===================
% Adapted for Multi-target all-report experiment settings
