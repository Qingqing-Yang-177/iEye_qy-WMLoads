function [ f_han ] = ii_plotalltrials_WMLoads( ii_data,ii_cfg,which_chans,nrows,ncols,epoch_chan,epoch_nums, fig_visible )
...
% ===============
% Adapted for 4 target condition
...
if nargin < 3 || isempty(which_chans)
    which_chans = {'X','Y','TarX1','TarY1','TarX2','TarY2','TarX3','TarY3','TarX4','TarY4'};
end
...
while trial_cnt <= ii_cfg.numtrials
    ...
    if contains(ii_cfg.vis,'TarX4')
        ii_plottrial(ii_data,ii_cfg,trial_cnt,{'X','Y','TarX1','TarY1','TarX2','TarY2','TarX3','TarY3','TarX4','TarY4'},thisax,'condensed',epoch_chan,epoch_nums);
    elseif contains(ii_cfg.vis,'TarX2')
        ii_plottrial(ii_data,ii_cfg,trial_cnt,{'X','Y','TarX1','TarY1','TarX2','TarY2'},thisax,'condensed',epoch_chan,epoch_nums);
    else
